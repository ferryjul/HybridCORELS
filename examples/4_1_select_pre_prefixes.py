...
for dataset_name in datasets:
    for min_coverage in min_coverageList:
        ...
        fileName = './results_part_4/results_4_1_learn_pre_prefixes_%s_%.3f.csv' %(dataset_name, min_coverage) #_proportions
        ...
        for index, row in res.iterrows():
            ...
            policy = row['Policy']
            validation_accuracy_prefix = row['Validation accuracy (prefix)']
