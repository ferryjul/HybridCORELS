...
corels_params = {'policy':"lower_bound", 'max_card':2, 'c':0.0, 'n_iter':10**6, 'min_support':0.05, 'verbosity':[]} #"progress"
...
beta_list = np.arange(0,1.0,0.05)

for min_coverage in beta_list:
    ...
    if method == 0:
        ...
        c = HybridCORELSClassifier(black_box_classifier=black_box, beta=beta_value, alpha=alpha_value, min_coverage=min_coverage, **corels_params)#"progress"
    elif method == 2:
